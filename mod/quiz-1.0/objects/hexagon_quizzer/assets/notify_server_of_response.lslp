       ...
       state ready{
            ...
            link_message(integer sender_num, integer num, string str, key user_key){
              ...
              http_response(key request_id, integer status, list metadata, string body) {
                    ...
                    if (placeinlist!=-1){
                          debug("Notify server response: "+body);
...
// SLOODLE LSL Script Git Location: mod/quiz-1.0/objects/multi_user_quiz/assets/notify_server_of_response.lslp

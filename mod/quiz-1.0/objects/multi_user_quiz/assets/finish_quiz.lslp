       ...
       state ready{
            ...
            link_message(integer sender_num, integer num, string str, key user_key){
                if (num == SLOODLE_CHANNEL_QUIZ_COMPLETED_FOR_AVATAR) {
			        ...
			        body += "&sloodlerequestdesc="+"FINISH_QUIZ";
              ...
              http_response(key request_id, integer status, list metadata, string body) {
                    ...
                    if (placeinlist!=-1){
                          debug("finish quiz response: "+body);
...
// SLOODLE LSL Script Git Location: mod/quiz-1.0/objects/multi_user_quiz/assets/finish_quiz.lslp

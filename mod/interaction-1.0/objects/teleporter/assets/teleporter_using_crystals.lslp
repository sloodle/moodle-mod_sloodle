...
default {
    ...
    state_entry() {
        ...
        llOwnerSay("Teleporter Starting up, listening for crytals on channel : "+(string)TARGET_CHANNEL);
...
// SLOODLE LSL Script Git Location: mod/interaction-1.0/objects/teleporter/assets/teleporter_using_crystals.lslp 

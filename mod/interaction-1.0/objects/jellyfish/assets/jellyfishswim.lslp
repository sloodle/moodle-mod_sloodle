...
changeColor(vector color, float alpha, float glow){
    ...
    integer j;
    for (j=0;j<num;j++){
        llSetLinkPrimitiveParamsFast(j,[PRIM_COLOR,ALL_SIDES,color,alpha,
...
// SLOODLE LSL Script Subversion Location: mod/interaction-1.0/object_scripts/jellyfishswim.lslp 

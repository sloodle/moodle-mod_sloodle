...
$string['rezzer:importingmoodleactivities'] = 'Importing Moodle Activities';
$string['rezzer:addobjects'] = 'Add objects';
$string['rezzer:savecurrentposition'] = 'Save current positions';
$string['rezzer:deletedderezzingobjects'] = 'Deleted, derezzing objects';
$string['rezzer:deletelayout'] = 'Delete this Scene';
$string['rezzer:deletinglayout'] = 'Deleting Scene';
$string['rezzer:deletelayout'] = 'Delete this Scene';
$string['rezzer:clonelayout'] = 'Clone this scene';
$string['rezzer:cloninglayout'] = 'Cloning scene';
$string['rezzer:renamelayout'] = 'Rename this scene';
$string['rezzer:renaminglayout'] = 'Renaming this scene';
$string['rezzer:renamebutton'] = 'Rename';
$string['rezzer:addobjectsforgroup'] = 'Add objects: {$a}';
$string['rezzer:updatingobject'] = 'Updating {$a}';
$string['rezzer:updateobject'] = 'Updating {$a}';
$string['rezzer:addingobject'] = 'Adding {$a}';
$string['rezzer:addobject'] = 'Add {$a}';
$string['rezzer:deleteobject'] = 'Delete {$a}';
$string['rezzer:deletingobject'] = 'Deleting {$a}';
